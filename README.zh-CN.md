...
本工程是基于`vue-element-admin`的二次开发。
...
```bash
# 克隆项目
git clone https://github.com/daisen/vue-element-admin.git
...
[MIT](https://github.com/HuangShengtao/vue-element-admin/blob/master/LICENSE)

Copyright (c) 2017-present HuangShengtao
